...
DEFAULT_CONFIG = {
    "ubee_executable": str(Path.home() / "ubee512" / "bin" / "ubee512"),
    "library_path": str(Path.home() / "ubee512" / "lib"),
    "search_root": str(Path.home() / ".ubee512"),
    "model_preset": "pcf",
    "rom256k": "none",
    "extra_args": "",
    "last_boot_mode": "Plain launch",
    "last_rom": str(Path.home() / ".ubee512" / "roms" / "rom1.bin"),
    "last_disk": "",
    "printer_output_file": str(Path.home() / ".ubee512" / "printer" / "printout.txt"),
    "printer_mode": "Off",
    ...
    "cpm_filename": "*.*",
    "cpm_target_name": "",
    "host_export_dir": str(Path.home() / "ubee512" / "exports"),
...
class UbeeLauncherApp:
    ...
    def _build_ui(self) -> None:
        ...
        ttk.Label(self.args_frame, text="Default ROM1").grid(row=1, column=0, sticky="nw", padx=(0, 8), pady=(10, 0))
