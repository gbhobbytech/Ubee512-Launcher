...
class UbeeLauncherApp:
    ...
    def update_mode_ui(self) -> None:
        ...
        if advanced:
            ...
            if self.model_var.get().strip() in ROM_TAPE_ONLY_MODELS:
    ...
    def on_model_changed(self, *_args) -> None:
        ...
        if self.advanced_mode_var.get() and model in ROM_TAPE_ONLY_MODELS:
    ...
    def build_command(self) -> list[str]:
        ...
        disk_flags_allowed = self.advanced_mode_var.get() and model not in ROM_TAPE_ONLY_MODELS
        ...
        # while Advanced mode is active and the selected model supports disks.
        # ROM/tape-only models such as IC suppress stale mounted disk flags.
